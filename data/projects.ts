...
const zhProjects: ProjectSummary[] = [
  ...
  },
  {
    ...
    tags: ["WEB", "SaaS", "UX Research", "UI Design"],
    tone: "laushu",
    category: "school",
    status: "published",
    href: "/laushu",
    ...
    seoDescription:
      "Laushu 勞贖勞務報酬系統設計優化案例研究：從紙本勞報流程出發，透過 UX Research、線框稿、互動原型與易用性測試改善數位化報帳體驗。",
  },
  {
    slug: "nccuspace",
    cardId: "project4",
...
const enProjects: ProjectSummary[] = [
  ...
  {
    slug: "laushu",
    title: "Laushu Contractor Payment System Design Optimization",
    date: "2024.3 - 2024.6",
    description:
    ...
    nextProjectSlug: "nccuspace",
    seoDescription:
      "A Laushu contractor payment system case study covering UX research, wireframes, interactive prototyping, and usability testing for a clearer digital payment workflow.",
  },
  {
    slug: "nccuspace",
    cardId: "project4",
