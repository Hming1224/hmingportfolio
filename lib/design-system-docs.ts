...
const componentSeeds: ComponentSeed[] = [
  ...
  { slug: "case-before-after", title: "CaseBeforeAfter", titleZh: "前後比較", category: "Case Study", source: "components/case-study/CaseBeforeAfter.tsx", status: "Source-level", statusZh: "Source-level", exampleLabel: "Two-panel comparison", exampleLabelZh: "雙欄比較", demo: "case-before-after", states: ["desktop horizontal", "mobile stacked"], usage: ["Use for simple two-panel before / after comparisons.", "Good when the comparison itself is reusable, but the route does not need a full narrative frame.", "Do not use it as a replacement for BeforeAfterNarrativeFrame.", "Current status: source-level reusable component with no current direct route adoption."], usageZh: ["適合用在單純的 before / after 雙欄比較。", "如果只是比較兩個狀態，不需要完整案例敘事框架，可以用它。", "不應拿來取代 BeforeAfterNarrativeFrame。", "目前是 source-level reusable component，正式案例 route 尚未直接採用。"], behavior: [{ label: "Scope", description: "Source-level reusable component for simple two-panel comparisons." }, { label: "Route adoption", description: "No current direct route adoption in Advantech, Crypto Arsenal, or Laushu." }, { label: "Boundary", description: "Not a replacement for BeforeAfterNarrativeFrame." }, { label: "Selector ownership", description: "The `.cs-before-after-panel` selector belongs to CaseBeforeAfter." }], behaviorZh: [{ label: "Scope", description: "Source-level reusable component，用於簡單雙欄比較。" }, { label: "Route adoption", description: "目前 Advantech、Crypto Arsenal、Laushu 都沒有直接 route adoption。" }, { label: "Boundary", description: "不是 BeforeAfterNarrativeFrame 的替代元件。" }, { label: "Selector ownership", description: "`.cs-before-after-panel` selector 屬於 CaseBeforeAfter。" }], anatomy: ["Before slot and after slot.", "Directional connector between the two panels.", "CaseBeforeAfter-owned `.cs-before-after-panel` panel shell.", "No scenario badge, narrative point list, or route-specific media judgment."], anatomyZh: ["Before slot 與 after slot。", "兩個 panel 之間的方向 connector。", "CaseBeforeAfter 自己擁有的 `.cs-before-after-panel` panel shell。", "不包含 scenario badge、敘事 point list 或 route-specific media 判斷。"], tokens: ["--cs-surface", "--cs-line", "--cs-accent", "--hm-space-md"], referenceCards: [{ label: "Source", value: "components/case-study/CaseBeforeAfter.tsx" }, { label: "CSS classes", value: ".cs-before-after / .cs-before-after-panel" }, { label: "Usage status", value: "No current direct route adoption" }, { label: "Boundary", value: ".cs-before-after-panel belongs to CaseBeforeAfter" }], referenceCardsZh: [{ label: "Source", value: "components/case-study/CaseBeforeAfter.tsx" }, { label: "CSS classes", value: ".cs-before-after / .cs-before-after-panel" }, { label: "Usage status", value: "目前沒有直接 route adoption" }, { label: "Boundary", value: ".cs-before-after-panel 屬於 CaseBeforeAfter" }], references: ["components/case-study/CaseBeforeAfter.tsx", "styles/case-study.css"] },
  { slug: "before-after-narrative-frame", title: "BeforeAfterNarrativeFrame", titleZh: "敘事型前後比較框架", category: "Case Study", source: "components/case-study/BeforeAfterNarrativeFrame.tsx", status: "Live route pattern", statusZh: "Live route pattern", exampleLabel: "Advantech / SolutionSection / Board 1", exampleLabelZh: "Advantech / SolutionSection / Board 1", demo: "before-after-narrative", states: ["blue", "cyan", "purple", "neutral", "slot-based"], usage: ["Use when a case-study section needs a guided before / after narrative.", "Use when the frame must carry scenario, design decision, and comparison structure.", "Live usage: Advantech, Crypto Arsenal, and Laushu.", "The frame owns the repeatable narrative shell; each route owns screenshots, redlines, sizing, and specific design judgment."], usageZh: ["適合用在案例頁需要引導式 before / after 敘事的段落。", "當畫面需要承載情境、設計決策與比較結構時使用。", "已用在 Advantech、Crypto Arsenal、Laushu。", "frame 負責可重複的敘事外框；截圖、redline、尺寸與專案判斷仍由各案例頁負責。"], behavior: [{ label: "Live usage", description: "Advantech, Crypto Arsenal, and Laushu." }, { label: "Frame owns", description: "Repeatable narrative shell, comparison layout, connector, and internal panel structure." }, { label: "Route owns", description: "Screenshots, redlines, sizing, and project-specific judgment." }, { label: "Internal part", description: "BeforeAfterPanel renders inside this frame only." }], behaviorZh: [{ label: "Live usage", description: "Advantech、Crypto Arsenal、Laushu。" }, { label: "Frame owns", description: "可重複的敘事外框、比較 layout、connector 與內部 panel structure。" }, { label: "Route owns", description: "截圖、redline、尺寸與專案判斷。" }, { label: "Internal part", description: "BeforeAfterPanel 只在這個 frame 裡渲染。" }], anatomy: ["Frame shell: CaseCard-based narrative container.", "Scenario badge / header: identifies the comparison moment.", "Before panel and after panel: rendered through BeforeAfterPanel inside the frame.", "Connector / comparison layout: owned by the frame.", "Narrative copy: optional point list supplied by the route.", "BeforeAfterPanel is internal anatomy, not a standalone route-level pattern or visible catalog item."], anatomyZh: ["Frame shell：以 CaseCard 為基底的敘事容器。", "Scenario badge / header：標示比較情境。", "Before panel 與 after panel：在 frame 內透過 BeforeAfterPanel 渲染。", "Connector / comparison layout：由 frame 負責。", "Narrative copy：由 route 提供的 optional point list。", "BeforeAfterPanel 是 internal anatomy，不是獨立的 route-level pattern，也不應作為獨立 catalog item 出現。"], tokens: ["--cs-accent", "--cs-surface", "--cs-line", "--hm-space-md", "--cs-before-after-state-panel-*"], referenceCards: [{ label: "Source", value: "components/case-study/BeforeAfterNarrativeFrame.tsx" }, { label: "Internal part", value: "BeforeAfterPanel" }, { label: "Live usage", value: "Advantech / Crypto Arsenal / Laushu" }, { label: "Boundary", value: "Route owns media, redlines, sizing, and project-specific judgment" }], referenceCardsZh: [{ label: "Source", value: "components/case-study/BeforeAfterNarrativeFrame.tsx" }, { label: "Internal part", value: "BeforeAfterPanel" }, { label: "Live usage", value: "Advantech / Crypto Arsenal / Laushu" }, { label: "Boundary", value: "media、redline、尺寸與專案判斷由 route 負責" }], references: ["components/case-study/BeforeAfterNarrativeFrame.tsx", "components/case-study/BeforeAfterPanel.tsx", "styles/case-study.css"] },
