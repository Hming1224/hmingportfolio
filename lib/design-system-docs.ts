...
const references: DesignSystemDoc[] = [
  ...
  },
  {
    ...
    usage: [
      ...
      "CaseTOC stays in Component Boundaries instead of Examples because it depends on the production case-study shell, section anchors, scroll position, and the desktop-only floating layout.",
    ...
    usageZh: [
      ...
      "CaseTOC 保留在 Component Boundaries，不放在 Examples，因為它依賴正式案例頁 shell、section anchors、scroll position 與桌機限定的 floating layout。",
