...
const componentSeeds: ComponentSeed[] = [
  ...
  },
  {
    ...
    titleZh: "標籤頁",
    category: "Navigation",
    source: "components/animate-ui/primitives/base/tabs.tsx",
    hideSourceInHeader: true,
    status: "Live source-level component",
    statusZh: "正式 source-level component",
    description: "Switches between related content groups without leaving the current section.",
    descriptionZh: "在同一區塊內切換同層級相關內容，不離開目前閱讀情境。",
    exampleLabel: "Homepage Selected Work categories",
    exampleLabelZh: "首頁 Selected Work 分類切換",
    demo: "tabs",
    usage: [
      "Use for related content groups that share the same section purpose.",
      "Use when switching content should not feel like page navigation.",
      "Do not use it as global navigation, pagination, or a substitute for a single content block.",
    ],
    usageZh: [
      "用於同一 section purpose 下的相關內容分組。",
      "當內容切換不應像跨頁導覽時使用。",
      "不要把它當成全站導覽、pagination，或只有單一內容區塊時硬加 tabs。",
    ],
    stateRows: [
    ...
    codeGuidance: {
      importPath: "components/animate-ui/primitives/base/tabs.tsx",
      example: "import {\n  Tabs,\n  TabsHighlight,\n  TabsHighlightItem,\n  TabsList,\n  TabsPanel,\n  TabsPanels,\n  TabsTab,\n} from \"@/components/animate-ui/primitives/base/tabs\";\n\n<Tabs defaultValue=\"enterprise\" className=\"project-tabs\">\n  <TabsHighlight className=\"project-tabs-highlight\">\n    <TabsList className=\"project-tabs-list\">\n      <TabsHighlightItem value=\"enterprise\" className=\"project-tabs-item\">\n        <TabsTab value=\"enterprise\" className=\"project-tabs-tab\">Industry Projects</TabsTab>\n      </TabsHighlightItem>\n    </TabsList>\n  </TabsHighlight>\n  <TabsPanels mode=\"wait\">\n    <TabsPanel value=\"enterprise\">...</TabsPanel>\n  </TabsPanels>\n</Tabs>",
      props: [
        { name: "defaultValue", type: "string", description: "Initial selected tab value.", usedBy: "Tabs" },
        { name: "value", type: "string", description: "Value used to match tab, highlight item, and panel.", usedBy: "TabsTab / TabsHighlightItem / TabsPanel" },
        { name: "mode", type: "AnimatePresenceProps['mode']", description: "Panel transition mode passed to AnimatePresence.", usedBy: "TabsPanels" },
        { name: "className", type: "string", description: "Styling hook supplied by the route or surface.", usedBy: "All primitives" },
      ],
      notes: [
        "Use the primitive API that production Works already uses.",
        "Do not invent a separate docs-only Tabs API.",
        "Keyboard arrow navigation is not currently implemented by the primitive.",
      ],
    },
    codeGuidanceZh: {
      importPath: "components/animate-ui/primitives/base/tabs.tsx",
      example: "import {\n  Tabs,\n  TabsHighlight,\n  TabsHighlightItem,\n  TabsList,\n  TabsPanel,\n  TabsPanels,\n  TabsTab,\n} from \"@/components/animate-ui/primitives/base/tabs\";\n\n<Tabs defaultValue=\"enterprise\" className=\"project-tabs\">\n  <TabsHighlight className=\"project-tabs-highlight\">\n    <TabsList className=\"project-tabs-list\">\n      <TabsHighlightItem value=\"enterprise\" className=\"project-tabs-item\">\n        <TabsTab value=\"enterprise\" className=\"project-tabs-tab\">企業應用</TabsTab>\n      </TabsHighlightItem>\n    </TabsList>\n  </TabsHighlight>\n  <TabsPanels mode=\"wait\">\n    <TabsPanel value=\"enterprise\">...</TabsPanel>\n  </TabsPanels>\n</Tabs>",
      props: [
        { name: "defaultValue", type: "string", description: "初始選取的 tab value。", usedBy: "Tabs" },
        { name: "value", type: "string", description: "用來對應 tab、highlight item 與 panel 的 value。", usedBy: "TabsTab / TabsHighlightItem / TabsPanel" },
        { name: "mode", type: "AnimatePresenceProps['mode']", description: "傳給 AnimatePresence 的 panel transition mode。", usedBy: "TabsPanels" },
        { name: "className", type: "string", description: "由 route 或 surface 提供的 styling hook。", usedBy: "All primitives" },
      ],
      notes: [
        "使用正式 Works 已採用的 primitive API。",
        "不要為文件站另外發明 docs-only Tabs API。",
    ...
    referenceCards: [
      { label: "Source path", value: "components/animate-ui/primitives/base/tabs.tsx" },
