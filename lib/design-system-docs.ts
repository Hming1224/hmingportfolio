...
const componentSeeds: ComponentSeed[] = [
  ...
  { slug: "modal", title: "Modal", titleZh: "對話框", category: "Feedback", source: "components/ui/Modal.tsx", demo: "modal", states: ["closed", "open", "keyboard focus", "dismissed"], usage: ["Backlog candidate.", "No current live usage in portfolio routes.", "Not a production example; use only when a real task must be interrupted for a response."], usageZh: ["Backlog 候選元件。", "目前正式作品集 route 尚未直接使用。", "不是目前正式站的 production example；只有真實任務必須被中斷並要求回應時才使用。"], tokens: ["--hm-paper", "--hm-ink", "--hm-shadow-xl", "--hm-radius-lg", "--hm-duration-base"], accessibility: ["開啟時焦點進入對話框，關閉時歸還。支援 Esc 關閉。"] },
  { slug: "skeleton", title: "Skeleton", titleZh: "骨架屏", category: "Feedback", source: "components/ui/Skeleton.tsx", demo: "skeleton", states: ["loading", "reduced motion"], usage: ["Backlog candidate.", "No current live usage in portfolio routes.", "Not a production example; use only when real data latency would otherwise shift layout."], usageZh: ["Backlog 候選元件。", "目前正式作品集 route 尚未直接使用。", "不是目前正式站的 production example；只有真實資料延遲會造成版面跳動時才使用。"], tokens: ["--hm-line", "--hm-duration-slow", "--hm-radius-md"], accessibility: ["需有 aria-busy 或 aria-hidden，避免讀取閃爍。"] },
