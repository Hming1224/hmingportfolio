...
const componentSeeds: ComponentSeed[] = [
  ...
  { slug: "case-section", title: "CaseSection", titleZh: "案例區塊", category: "Case Study", source: "components/case-study/CaseSection.tsx", demo: "case-section", states: ["paper", "surface", "custom class"], usage: ["Live example reflects Crypto Arsenal problem-section rhythm and Advantech normal section anchors.", "Wraps normal case-study content sections and anchors them for CaseTOC.", "Paper and surface variants create reading rhythm; highly custom full-bleed sections can stay route-local."], usageZh: ["範例對齊 Crypto Arsenal problem-section 節奏與 Advantech 一般 section anchor。", "包裝一般案例內容 section，並提供 CaseTOC 錨點。", "paper / surface variant 建立閱讀節奏；高度客製滿版 section 可保留 route-local。"], tokens: ["--hm-container", "--cs-surface", "--cs-line", "--hm-space-3xl"] },
  {
    ...
    status: "Live case-study component",
    statusZh: "正式案例元件",
    description: "Introduces a case-study section with an eyebrow, title, and optional supporting copy.",
    descriptionZh: "用於案例頁段落開頭，以 eyebrow、標題與輔助說明建立段落脈絡。",
    ...
    behavior: [
      ...
      { label: "Supporting copy", description: "Optional description renders below the title before the divider." },
    ...
    behaviorZh: [
      ...
      { label: "Supporting copy", description: "optional description 出現在 title 下方、divider 之前。" },
    ...
    anatomyParts: [
      ...
      { part: "Supporting copy", description: "Optional explanatory copy below the title.", owner: "CaseSectionHeader", code: ".cs-section-description" },
      { part: "Divider", description: "Visual separator that closes the intro block.", owner: "CaseSectionHeader", code: ".cs-divider" },
    ],
    anatomyPartsZh: [
      ...
      { part: "Supporting copy", description: "標題下方的 optional 說明文字。", owner: "CaseSectionHeader", code: ".cs-section-description" },
      { part: "Divider", description: "收束 intro block 的視覺分隔線。", owner: "CaseSectionHeader", code: ".cs-divider" },
    ],
    codeGuidance: {
      importPath: "components/case-study/CaseSectionHeader.tsx",
      example: "import { CaseSectionHeader } from \"@/components/case-study\";\n\n<CaseSectionHeader\n  kicker=\"Problem Definition\"\n  title=\"Users could see strategy PnL, but not the actual position state\"\n  description=\"Optional supporting copy can introduce the route-specific content that follows.\"\n/>",
      props: [
        ...
        { name: "description", type: "ReactNode", description: "Optional supporting copy shown below the title." },
      ...
      notes: ["Use CaseHero for page-level case introductions.", "Keep route-specific heading geometry outside this component."],
    },
    codeGuidanceZh: {
      importPath: "components/case-study/CaseSectionHeader.tsx",
      example: "import { CaseSectionHeader } from \"@/components/case-study\";\n\n<CaseSectionHeader\n  kicker=\"問題定義\"\n  title=\"用戶痛點：整體策略賺賠看得到，倉位狀態卻看不見\"\n  description=\"可選的輔助說明，用來銜接後續 route-specific 內容。\"\n/>",
      props: [
        { name: "title", type: "ReactNode", description: "必填的 section `h2` 標題內容。" },
        { name: "kicker", type: "ReactNode", description: "標題上方的 optional eyebrow。" },
        { name: "description", type: "ReactNode", description: "標題下方的 optional supporting copy。" },
      ...
      notes: ["頁面層級的案例介紹使用 CaseHero。", "route-specific 標題幾何不要塞進這個 component。"],
    },
    tokenMappings: [
      ...
      { token: ".cs-section-description", role: "Supporting copy", usage: "Uses `--cs-text-secondary` and body line-height." },
    ...
    tokenMappingsZh: [
      ...
      { token: ".cs-section-description", role: "Supporting copy", usage: "使用 `--cs-text-secondary` 與 body line-height。" },
      { token: ".cs-divider", role: "Divider", usage: "使用共用 case-study divider style。" },
    ],
    accessibility: ["Keep heading levels in route order; this component renders an `h2`.", "Do not skip the section title when an eyebrow is present.", "Description should support the heading, not replace it."],
    accessibilityZh: ["維持 route 內 heading 層級順序；此元件會 render `h2`。", "有 eyebrow 時仍不能省略 section title。", "description 用來補充 heading，不應取代 heading。"],
    tokens: [".cs-section-header", ".cs-section-kicker", ".cs-section-title", ".cs-section-description", ".cs-divider", "--cs-text-heading", "--cs-text-secondary", "--cs-accent"],
    referenceCards: [
      ...
      { label: "CSS", value: "styles/case-study.css: .cs-section-header / .cs-section-title / .cs-section-description" },
