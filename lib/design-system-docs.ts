...
const componentSeeds: ComponentSeed[] = [
  ...
  { slug: "case-hero", title: "CaseHero", titleZh: "案例 Hero", category: "Case Study", source: "components/case-study/CaseHero.tsx", demo: "case-hero", states: ["Advantech", "Crypto Arsenal", "Laushu", "mobile"], usage: ["Owns the reusable case-study hero shell: cover, title area, tags, summary, and project metadata composition.", "Cover media can be full-bleed, but readable content stays inside the 1440px content container."], usageZh: ["負責案例頁 Hero 的共用骨架：封面、標題區、標籤、摘要與專案資訊組合。", "封面可 full-bleed，但可讀內容維持在 1440px 內容寬內。"], tokens: ["--hm-container", "--text-heading", "--cs-accent", "--cs-surface"], accessibility: ["Hero heading remains the page-level title for the case study."], accessibilityZh: ["Hero 標題維持案例頁主標語意。"] },
  { slug: "case-section", title: "CaseSection", titleZh: "案例區塊", category: "Case Study", source: "components/case-study/CaseSection.tsx", demo: "case-section", states: ["paper", "surface", "custom class"], usage: ["Wraps normal case-study content sections and anchors them for CaseTOC.", "Paper and surface variants create reading rhythm; highly custom full-bleed sections can stay route-local."], usageZh: ["包裝一般案例內容 section，並提供 CaseTOC 錨點。", "paper / surface variant 建立閱讀節奏；高度客製滿版 section 可保留 route-local。"], tokens: ["--hm-container", "--cs-surface", "--cs-line", "--hm-space-3xl"] },
  { slug: "case-section-header", title: "CaseSectionHeader", titleZh: "案例區塊標題", category: "Case Study", source: "components/case-study/CaseSectionHeader.tsx", demo: "section-heading", states: ["default", "secondary", "warning", "inverse"], usage: ["Standardizes kicker, title, and optional description anatomy for case-study sections.", "Use it before adding route-local heading geometry."], usageZh: ["統一案例 section 的 kicker、title 與 optional description 結構。", "新增 route-local 標題幾何前，先使用這個共用標題骨架。"], tokens: ["--cs-text-heading", "--cs-text-secondary", "--cs-accent"] },
  { slug: "case-card", title: "CaseCard", titleZh: "案例卡片", category: "Case Study", source: "components/case-study/CaseCard.tsx", demo: "case-section", states: ["default", "accent", "metric", "media"], usage: ["Shared card shell for stable case-study content blocks.", "Do not use it to absorb timeline, flow, matrix, or diagram geometry."], usageZh: ["穩定案例內容區塊的共用卡片外框。", "不要拿它吸收 timeline、flow、matrix 或 diagram 的內容幾何。"], tokens: ["--cs-surface", "--cs-line", "--hm-radius-lg", "--shadow-sm"] },
  { slug: "case-grid", title: "CaseGrid", titleZh: "案例網格", category: "Case Study", source: "components/case-study/CaseGrid.tsx", demo: "case-section", states: ["two", "three", "four", "auto", "stack"], usage: ["Shared responsive grid shell for cards and repeatable case-study content.", "Special matrix columns, timeline widths, and diagram min-width values remain local."], usageZh: ["卡片與重複案例內容的共用 RWD grid 外框。", "特殊矩陣欄位、timeline 寬度與 diagram min-width 留在 local。"], tokens: ["--hm-grid-gutter", "--hm-space-md", "--hm-container"] },
  { slug: "case-media", title: "CaseMedia", titleZh: "案例媒體", category: "Case Study", source: "components/case-study/CaseMedia.tsx", demo: "zoom", states: ["contained", "full", "zoomable", "scroll"], usage: ["Owns figure, media frame, optional caption, and scroll-container shell.", "Does not own crop, aspect ratio, video behavior, or flow / matrix / diagram geometry."], usageZh: ["負責 figure、media frame、optional caption 與 scroll-container 外框。", "不負責裁切比例、影片行為、流程圖 / 矩陣 / diagram 幾何。"], tokens: ["--cs-surface", "--cs-line", "--hm-radius-lg"] },
  { slug: "case-before-after", title: "CaseBeforeAfter", titleZh: "前後比較", category: "Case Study", source: "components/case-study/CaseBeforeAfter.tsx", demo: "case-section", states: ["desktop horizontal", "mobile stacked"], usage: ["Simple two-panel before / after comparison component.", "It remains independent and has not been refactored to use BeforeAfterPanel.", "The .cs-before-after-panel selector boundary belongs to CaseBeforeAfter."], usageZh: ["簡單兩欄 before / after 比較元件。", "目前仍是獨立元件，尚未改用 BeforeAfterPanel。", "`.cs-before-after-panel` selector 邊界屬於 CaseBeforeAfter。"], tokens: ["--cs-surface", "--cs-line", "--cs-accent", "--hm-space-md"] },
  { slug: "before-after-narrative-frame", title: "BeforeAfterNarrativeFrame", titleZh: "敘事型前後比較框架", category: "Case Study", source: "components/case-study/BeforeAfterNarrativeFrame.tsx", demo: "case-section", states: ["blue", "cyan", "purple", "neutral", "slot-based"], usage: ["Implemented shared slot-based narrative layout frame for single-comparison before / after stories.", "Owns the CaseCard shell, header / badge / title anatomy, optional intro, points, panel layout, connector, and data-tone hook.", "Does not own media wrappers, lightbox behavior, redlines, image sizing, crop, figure semantics, or route-specific storytelling geometry.", "Adopted by Crypto IterationSection, Laushu iteration board, and Advantech Board 1 pilot; Advantech Board 2 / 3 remain route-local."], usageZh: ["已實作的 slot-based 敘事型 before / after 共用 layout frame，適合單一比較故事。", "負責 CaseCard 外框、header / badge / title、optional intro、points、panel layout、connector 與 data-tone hook。", "不負責 media wrapper、lightbox、redline、圖片尺寸 / 裁切、figure 語意或 route-specific storytelling geometry。", "已用於 Crypto IterationSection、Laushu iteration board、Advantech Board 1 pilot；Advantech Board 2 / 3 仍保留 route-local。"], tokens: ["--cs-accent", "--cs-surface", "--cs-line", "--hm-space-md"] },
  { slug: "before-after-panel", title: "BeforeAfterPanel", titleZh: "Before / After 視覺面板", category: "Case Study", source: "components/case-study/BeforeAfterPanel.tsx", demo: "case-section", states: ["blue", "cyan", "purple", "neutral"], usage: ["Shared visual shell for one labeled before / after state panel.", "Used internally by BeforeAfterNarrativeFrame only; not directly route-adopted.", "Not used by CaseBeforeAfter and not a semantic figure component."], usageZh: ["單一 before / after 狀態面板的共用視覺外框。", "目前只供 BeforeAfterNarrativeFrame 內部使用，沒有直接 route adoption。", "未被 CaseBeforeAfter 使用，也不是 semantic figure component。"], tokens: ["--cs-before-after-state-panel-*", "--cs-accent", "--cs-surface", "--cs-line"] },
  { slug: "zoomable-image", title: "ZoomableImage", titleZh: "可放大圖片", category: "Case Study", source: "components/case-study/ZoomableImage.tsx", demo: "zoom", states: ["default", "hover", "focus", "lightbox open", "fullscreen mode"], usage: ["Owns shared image display, zoom trigger, and image lightbox behavior.", "Does not own route-specific crop / ratio, video playback, video lightbox, or flow / matrix / diagram layout."], usageZh: ["負責共用圖片顯示、放大 trigger 與 image lightbox 行為。", "不負責 route-specific 裁切 / 比例、影片播放、影片 lightbox 或流程圖 / 矩陣 / diagram layout。"], tokens: ["--hm-paper", "--hm-ink", "--hm-shadow-xl", "--hm-z-modal"], accessibility: ["Includes dialog semantics, aria-modal, localized close label, Escape close, backdrop close, and scroll lock.", "Focus trap / return-focus is a documented future improvement unless code implements it."], accessibilityZh: ["包含 dialog 語意、aria-modal、本地化關閉文字、Escape 關閉、backdrop 關閉與 scroll lock。", "focus trap / return-focus 仍屬 future improvement，除非 code 已實作。"] },
  { slug: "flow-scroll-hint", title: "FlowScrollHint", titleZh: "橫向捲動提示", category: "Case Study", source: "components/case-study/FlowScrollHint.tsx", demo: "case-section", states: ["hidden", "visible when next scroll container overflows"], usage: ["Decorative overflow affordance for wide flow, table, matrix, or diagram content.", "It detects the following sibling scroll container and toggles data-visible.", "Do not expand it into an interactive control or accessible instruction unless a future accessibility task reopens the decision."], usageZh: ["寬版 flow、table、matrix 或 diagram 的裝飾型 overflow 提示。", "偵測下一個 sibling scroll container，並切換 data-visible。", "未來 accessibility 任務重開前，不要把它擴成互動控制或可讀指示文字。"], tokens: ["--hm-muted", "--hm-duration-fast"], accessibility: ["Currently aria-hidden decorative UI by governance decision."], accessibilityZh: ["依治理決策，目前維持 aria-hidden 裝飾 UI。"] },
...
const references: DesignSystemDoc[] = [
  ...
  },
  {
    ...
    title: "Local Components and Exceptions",
    titleZh: "Local 元件與例外",
    description: "Protected or route-local patterns that should be documented, not abstracted into shared components by default.",
    descriptionZh: "應被文件化、但預設不抽成共用元件的受保護或 route-local pattern。",
    category: "Reference",
    usage: [
      "Advantech Board 2 / Board 3 remain route-local multi-comparison boards until a separate multi-comparison contract exists.",
      "ProjectCard hover overlay and CTA layout are protected; do not change without explicit approval.",
      "CaseTOC floating behavior is protected navigation.",
      "Laushu task flow keeps route-local diagram geometry, connector endpoints, and min-width rules.",
      "Crypto matrix / FlowMatrixBoard remains visual storytelling content, not an ARIA grid or shared matrix component.",
    ],
    usageZh: [
      "Advantech Board 2 / Board 3 在多比較 contract 成立前維持 route-local。",
      "ProjectCard hover overlay 與 CTA layout 受保護，未明確批准前不要改。",
      "CaseTOC 的浮動導覽行為受保護。",
      "Laushu task flow 的圖形幾何、connector 端點與 min-width 規則維持 route-local。",
      "Crypto matrix / FlowMatrixBoard 是視覺敘事內容，不是 ARIA grid 或 shared matrix component。",
    ],
    references: ["docs/design-system/06-governance.md", "docs/design-system/03-components.md"],
  },
  {
    kind: "reference",
    slug: "gaps",
