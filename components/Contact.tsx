          ...
          >
            <div className="contact-info-card">
              <div className="contact-info-header">
                ...
                <p className="contact-subtitle">留下訊息，或是透過以下管道與我聯繫！</p>
              </div>

              <div className="contact-methods">
                {/* Email Method */}
                <div className="contact-method-item email-card" onClick={handleCopyEmail}>
                  ...
                  <div className="method-details">
                    ...
                    <span className="method-value">hmingdesigner@gmail.com</span>
                  </div>
                  <button className={`copy-btn ${copied ? 'copied' : ''}`} aria-label="複製信箱">
                    {copied ? "已複製！" : "複製"}
                  </button>
                </div>

                {/* Social Card: LinkedIn */}
                <a href="https://www.linkedin.com/in/brian-huang-a36759128/" target="_blank" rel="noopener noreferrer" className="contact-method-item social-card">
                ...
                {/* Social Card: GitHub */}
                <a href="https://github.com/Hming1224" target="_blank" rel="noopener noreferrer" className="contact-method-item social-card">
                ...
                >
                  ...
                  {status === 'loading' && (
                    <span className="btn-content">
                      <svg className="spinner-icon animate-spin" width="18" height="18" viewBox="0 0 24 24" fill="none">
                  ...
                  {status === 'success' && (
                    <span className="btn-content">
                      <svg className="success-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
