...
export default async function CurrentSection() {
  ...
  return (
    <section id="cs-sec-current" className="cs-section-surface">
      <CaseSectionHeader kicker={t("介面現況")} title={t("策略在 CA、倉位卻要去交易所看")} />
      ...
      <CaseMedia className="cs-media--compact-gap" variant="full">
        <Image
