...
const en = {
  ...
  "把交易控制權帶回 CA，讓使用者不必離站或中斷策略也能管理風險。": "Bring trade control back into CA so users can manage risk without leaving the platform or interrupting their strategies.",
  "設計假設": "Design hypothesis",
  "如果把交易所熟悉的倉位、平倉與止盈止損模式整合進 CA，並讓人工操作與策略狀態同步，使用者就能在不中斷策略的情況下完成風險控制，並提高對操作結果的信心。": "If familiar position, close, and take-profit/stop-loss patterns are integrated into CA while manual actions stay synchronized with strategy status, users can manage risk without interrupting their strategies and feel more confident in the outcome.",
  "How might we": "How might we",
  "我們如何讓使用自動交易策略的使用者，不必離開 CA 或中斷策略，就能看懂倉位、完成必要的風險控制，並對操作結果建立足夠信心？": "How might we help people using automated strategies understand their positions, complete essential risk controls, and feel confident in the outcome without leaving CA or interrupting their strategies?",
  ...
  "將三項風險控制流程整合進 CA，平均操作時間縮短 58%；止盈止損判讀仍待優化。": "Bringing three risk-control flows into CA cut average task time by 58%; take-profit and stop-loss interpretation remains the next priority.",
