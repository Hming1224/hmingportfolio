...
export const resultCards = [
  ...
  },
  {
    ...
    desc: "研究後我發現，不能期待廠務人員每次都主動打開聊天框，還要先想好怎麼問。因此，我改成讓系統在適合的時機主動顯示分析，例如直接放在原本的圖表、透過通知提醒，再讓使用者需要時繼續追問。",
  },
  {
    num: "03",
    title: "把產業規則拆成可驗證的介面與資料假設",
    desc: "面對複雜的需量計價規則，我先和產品、資料及工程團隊確認資料多久更新一次、什麼情況算超約，以及系統要怎麼找出高耗電設備。把規則拆清楚後，我才能知道哪些資訊可以直接顯示，哪些還不能過度承諾。",
  },
  {
    num: "04",
    title: "AI 信任來自可控邊界與專家回饋",
    desc: "能源管理不能直接相信 AI 看起來合理的答案。因此，工程團隊先限制它能回答的問題和可使用的資料，並把結果定位成協助判斷的參考，而不是直接替人做決定。現場人員也能記錄最後的處理方式，讓這些經驗成為之後分析的依據。",
  },
];
